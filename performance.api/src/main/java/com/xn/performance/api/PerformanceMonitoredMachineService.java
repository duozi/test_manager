...
public interface PerformanceMonitoredMachineService {
     ...
     * @return 集合,如果不存在,返回Empty List
     */
    PageResult<PerformanceMonitoredMachineDto> listByPage(PerformanceMonitoredMachineDto condition, PageInfo pageInfo) throws IllegalAccessException, IntrospectionException, InvocationTargetException;
