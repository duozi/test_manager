 ...
 * Created by xn056839 on 2017/5/13.
 */
...
public class BeanToMapUtil {
    ...
    public static void main(String[] args) {
        PerformancePlan performancePlan=new PerformancePlan(2);
        performancePlan.setIsDelete("未删除");
        try {
            Map map=convertBean(performancePlan);
            logger.info("over");
