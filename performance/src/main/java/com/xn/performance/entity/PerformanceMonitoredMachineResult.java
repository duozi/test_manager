...
/**
 * PerformanceMonitoredMachineResult 实体类
 * 
 * @author zhouxi
 * @date 2017-02-21
 */
public class PerformanceMonitoredMachineResult extends BaseEntity {
	...
	public PerformanceMonitoredMachineResult(){
	    // default constructor
	}
    
    public PerformanceMonitoredMachineResult(Integer id){
        this.id = id;
    }
